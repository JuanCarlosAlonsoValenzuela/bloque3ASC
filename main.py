...
print(population[4].neighbors)
weight = 0
# lambda_x = []
# lambda_y = []
# for i in population[weight].neighbors:
#     lambda_x.append(population[weight].neighbors[i][0])
#     lambda_y.append(population[weight].neighbors[i][1])
#
# plt.scatter(lambda_x, lambda_y)
# plt.show()
...
while i < G:
    ...
    plt.scatter(f_1[0:80], f_2[0:80], color='b', s=0.5)
    plt.plot(f_1[80:], f_2[80:], '.',color='r')
